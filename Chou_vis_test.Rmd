...
setwd("/Users/hankchou/Documents/NTHU/2025_1/programming in business/final project/test_1103")
getwd()
require(readr)
require(dplyr)
require(ggplot2)
```
```{r dataset}
user_logs = read_csv("./archive/users.csv")
head(user_logs)
movies = read_csv("./archive/movies.csv")
watch_history_logs = read_csv("./archive/watch_history.csv")
recommendation_logs = read_csv("./archive/recommendation_logs.csv")
```
